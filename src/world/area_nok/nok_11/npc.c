...
#include "world/common/npc/Busytown_Stationary.inc.c"
...
NpcData N(NpcData_Lowly)[] = {
    {
        ...
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_NO_SHADOW_RAYCAST | ENEMY_FLAG_CANT_INTERACT,
        .drops = NO_DROPS,
...
NpcData N(NpcData_Huckle)[] = {
    {
        ...
        .pos = { GEN_HUCKLE_VEC },
        .yaw = GEN_HUCKLE_DIR,
        .init = &N(EVS_NpcInit_Huckle),
        .settings = &N(NpcSettings_Huckle_Stationary),
        .flags = BASE_PASSIVE_FLAGS | ENEMY_FLAG_NO_SHADOW_RAYCAST | ENEMY_FLAG_CANT_INTERACT,
        .drops = NO_DROPS,
        .animations = HUCKLE_ANIMS,
        // .tattle = MSG_NONE,
    },
};
